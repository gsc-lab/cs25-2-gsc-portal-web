...
export const postCourse = async (courseData) => {
  try {
    const res = await api.post(`/timetables/registerCourses`, {
...
export const postTimetable = async (TimetableData) => {
  try {
    const res = await api.post(`/timetables/registerTimetable`, {
...
export const postFukaStudents = async (fukaData) => {
  try {
    const res = await api.post(`/timetables/huka/student`, {
...
export const postFukaCustomStudents = async (fukaData) => {
  try {
    const res = await api.post(`/timetables/huka/student/custom`, {
      student_ids: fukaData.student_ids,
      date: fukaData.date,
      start_slot: fukaData.startTime,
      end_slot: fukaData.endTime,
...
export const postClassStudents = async (class_id, student_ids) => {
  try {
    const res = await api.post(`/timetables/classes/${class_id}/assign`, {
...
export const getStudentTimetable = async (today) => {
  try {
    ...
    console.log('학생 시간표 정보 조회', res.data.data)
    return res.data.data
  } catch (e) {
    errorMsg(e)
  }
...
export const getProfessorTimetable = async (today) => {
  try {
    ...
    console.log('교수 시간표 정보 조회', res.data.data)
    return res.data.data
  } catch (e) {
    errorMsg(e)
  }
...
export const getAdminTimetable = async (today) => {
  try {
    ...
    console.log('시간표 정보 조회', res.data.data)
    return res.data.data
  } catch (e) {
    errorMsg(e)
  }
...
export const getEvent = async () => {
  try {
    ...
    console.log('휴보강 이력', res.data.data)
    return res.data.data
  } catch (e) {
    errorMsg(e)
  }
...
export const getSpecialClasses = async () => {
  try {
    ...
    console.log('Special 반 : ', res.data.data)
    return res.data.data
  } catch (e) {
    errorMsg(e)
  }
...
export const getKoreanClasses = async () => {
  try {
    ...
    console.log('Korean 반 : ', res.data.data)
    return res.data.data
  } catch (e) {
    errorMsg(e)
  }
...
// 해당 날짜& 정보 조회
// ---------------------------------------------------------------
export const getDateSchedule = async (grade, date) => {
  try {
    const res = await api.get(`/timetables/gradeDate`, {
      params: {
        grade: grade,
        date: date,
      },
...
export const delEvent = async (id) => {
  try {
    await api.delete(`/timetables/registerHoliday/${id}`)
  } catch (e) {
    errorMsg(e)
  }
}
