<template>
  <div class="flex justify-center items-center gap-2 mt-12 mb-8" v-if="totalPages > 0">
    ...
    <button
      ...
      :key="page"
      :class="[
        'flex justify-center items-center min-w-9 h-9 px-1 border border-gray-200 bg-white text-gray-500 rounded-md text-sm font-medium cursor-pointer transition-all duration-200',
        { 'bg-primary border-primary text-black font-bold shadow-md': page === currentPage },
      ]"
