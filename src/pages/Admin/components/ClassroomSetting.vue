  ...
  <div class="p-4">
    ...
    <div class="overflow-x-auto rounded-lg border border-gray-200 shadow-subtle bg-bg-paper">
      <table class="w-full border-collapse min-w-full divide-y divide-gray-200">
        ...
        <tbody>
          <!-- ====================  추가  ==================== -->
          <tr v-if="postData?.classroom_id == 'new'" class="divide-y divide-gray-200 hover:bg-gray-50">
            ...
            <td class="text-sm py-2 px-3 border-b border-gray-200 text-center">
              <select v-model="postData.room_type" class="w-full px-2 py-1 border border-gray-200 rounded-base shadow-sm focus:outline-none focus:ring-primary focus:border-primary text-sm">
            ...
            <td class="text-sm py-2 px-3 border-b border-gray-200 text-center">
              <button @click="resetPostData" class="px-3 py-1 bg-white text-text-base border border-gray-200 rounded-base text-sm font-medium shadow-sm hover:bg-gray-50 transition-colors duration-200">취소</button>
            </td>
          </tr>

          <!-- ====================  출력/수정  ==================== -->
          <tr v-for="(classroom, idx) in classrooms" :key="idx" class="divide-y divide-gray-200 hover:bg-gray-50">
            <td class="text-sm py-2 px-3 border-b border-gray-200 text-center">{{ classroom.classroom_id }}</td>
            <!--  장소  -->
            <td class="text-sm py-2 px-3 border-b border-gray-200 text-center">
            ...
            <td class="text-sm py-2 px-3 border-b border-gray-200 text-center">
              ...
              <div v-else>
                <button @click="setPostData(classroom)" class="px-3 py-1 bg-white text-text-base border border-gray-200 rounded-base text-sm font-medium shadow-sm hover:bg-gray-50 transition-colors duration-200">수정</button>
              </div>
            </td>

            <td class="text-sm py-2 px-3 border-b border-gray-200 text-center">
              <div v-if="classroom.classroom_id == postData.classroom_id">
                <button @click="postData.classroom_id = ''" class="px-3 py-1 bg-white text-text-base border border-gray-200 rounded-base text-sm font-medium shadow-sm hover:bg-gray-50 transition-colors duration-200">취소</button>
              </div>
